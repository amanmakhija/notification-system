...
* The original package name 'com.aman.notification-system' is invalid and this project uses 'com.aman.notification_system' instead.
...
* [WebSocket](https://docs.spring.io/spring-boot/3.5.12/reference/messaging/websockets.html)
* [Spring Data JPA](https://docs.spring.io/spring-boot/3.5.12/reference/data/sql.html#data.sql.jpa-and-spring-data)
* [Spring for Apache Kafka](https://docs.spring.io/spring-boot/3.5.12/reference/messaging/kafka.html)
* [Spring Data Reactive Redis](https://docs.spring.io/spring-boot/3.5.12/reference/data/nosql.html#data.nosql.redis)
